...
func (nu *NewUser) Validate() error {
	...
	if nu.Password != nu.PasswordConf {
		return fmt.Errorf("Password and PasswordConf do not match")
	}
...
func (nu *NewUser) ToUser() (*User, error) {
	...
	user.PhotoURL = "https://www.gravatar.com/avatar/" + ehash
...
func (u *User) SetPassword(password string) error {
	...
	u.PassHash, _ = bcrypt.GenerateFromPassword([]byte(password), bcryptCost)
	return nil
}
